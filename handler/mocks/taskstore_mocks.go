...
// Source: github.com/aws/amazon-ecs-event-stream-handler/handler/store (interfaces: TaskStore)
...
func (_m *MockTaskStore) AddTask(_param0 string) error {
...
func (_m *MockTaskStore) AddUnversionedTask(_param0 string) error {
	ret := _m.ctrl.Call(_m, "AddUnversionedTask", _param0)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (_m *MockTaskStore) DeleteTask(_param0 string, _param1 string) error {
...
func (_m *MockTaskStore) FilterTasks(_param0 string, _param1 string) ([]types.Task, error) {
	ret := _m.ctrl.Call(_m, "FilterTasks", _param0, _param1)
...
func (_m *MockTaskStore) GetTask(_param0 string, _param1 string) (*types.Task, error) {
...
func (_m *MockTaskStore) StreamTasks(_param0 context.Context) (chan types0.TaskErrorWrapper, error) {
	ret := _m.ctrl.Call(_m, "StreamTasks", _param0)
