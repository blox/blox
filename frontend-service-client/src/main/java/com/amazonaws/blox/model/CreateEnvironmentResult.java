...
public class CreateEnvironmentResult extends com.amazonaws.opensdk.BaseResult implements Serializable, Cloneable {
    ...
    public CreateEnvironmentResult environmentRevisionId(String environmentRevisionId) {
