...
func (_m *MockEtcdInterface) Put(ctx context.Context, key string, val string, opts ...clientv3.OpOption) (*clientv3.PutResponse, error) {
	_s := []interface{}{ctx, key, val}
	for _, _x := range opts {
		_s = append(_s, _x)
	}
...
func (_m *MockEtcdInterface) Get(ctx context.Context, key string, opts ...clientv3.OpOption) (*clientv3.GetResponse, error) {
...
func (_m *MockEtcdInterface) Delete(ctx context.Context, key string, opts ...clientv3.OpOption) (*clientv3.DeleteResponse, error) {
	_s := []interface{}{ctx, key}
	for _, _x := range opts {
		_s = append(_s, _x)
	}
