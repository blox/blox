 ...
 */
package com.amazonaws.blox.dataservice.old.mapper;
...
public interface ApiModelMapper {
  ...
  EnvironmentType toWrapperEnvironmentType(
      com.amazonaws.blox.dataservice.old.model.EnvironmentType environmentType);

  com.amazonaws.blox.dataservice.old.model.EnvironmentType toModelEnvironmentType(
      EnvironmentType environmentType);

  InstanceGroup toWrapperInstanceGroup(
      com.amazonaws.blox.dataservice.old.model.InstanceGroup instanceGroup);

  com.amazonaws.blox.dataservice.old.model.InstanceGroup toModelInstanceGroup(
      InstanceGroup instanceGroup);

  Attribute toWrapperAttribute(com.amazonaws.blox.dataservice.old.model.Attribute attribute);

  com.amazonaws.blox.dataservice.old.model.Attribute toModelAttribute(Attribute attribute);

  DeploymentConfiguration toWrapperDeploymentConfiguration(
      com.amazonaws.blox.dataservice.old.model.DeploymentConfiguration deploymentConfiguration);

  com.amazonaws.blox.dataservice.old.model.DeploymentConfiguration toModelDeploymentConfiguration(
